		...
		<view class="list b-b" v-for="(item, index) in addressList" :key="index" @click="checkAddress(item)">
			<view class="wrapper">
				<view class="address-box">
					...
					<text class="address">{{item.addressName}} {{item.tel}}</text>
				</view>
				<view class="u-box">
					<text class="name">{{item.province}}</text>
					<text class="mobile">{{item.adress}}</text>
				</view>
			</view>
		...
		onLoad(option) {
			...
			adList({
			...
			}).then(function(res) {
				{
					...
					window.localStorage.setItem("AddressList", result);
